[![Passing tests on master](https://travis-ci.org/oliverlorenz/repo-baseline-file-available.svg?branch=master)](https://travis-ci.org/oliverlorenz/repo-baseline-file-available)
